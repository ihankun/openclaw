...
export const en: TranslationMap = {
  ...
  nodes: {
    ...
    devices: {
      ...
      rotate: "Rotate",
      revoke: "Revoke",
      rejectConfirmation: "Reject this device pairing request?",
      newTokenPrompt: "New device token (copy and store securely):",
      revokeConfirmation: "Revoke token for {deviceId} ({role})?",
    },
    binding: {
    ...
    execApprovals: {
      ...
      missingHash: "Exec approvals hash missing; reload and retry.",
      ...
      fallbackUnavailable: "Applied when the UI prompt is unavailable.",
      fallback: "Fallback",
      autoAllowSkillClis: "Auto-allow skill CLIs",
      autoAllowSkillClisHint: "Allow skill executables listed by the Gateway.",
      usingDefault: "Using default ({state}).",
  ...
  skillsView: {
    ...
    shown: "{count} shown",
    clawhub: {
      description: "Search and install skills from the registry",
      searchPlaceholder: "Search ClawHub skills…",
      searching: "Searching…",
      acknowledgeRisk: "Acknowledge risk and install",
      noResults: "No skills found on ClawHub.",
      ...
      linkInvalid: "ClawHub link invalid",
      refreshing: "Refreshing…",
    ...
    detail: {
      ...
      saveKey: "Save key",
      source: "Source:",
      loadingCard: "Loading Skill Card…",
      cardNotLoaded: "Skill Card not loaded.",
    },
    groups: {
    ...
    reasons: {
      ...
      blockedByAgentFilter: "blocked by agent filter",
    },
    messages: {
      reviewWarning: "Review the ClawHub warning before installing this skill.",
      enabled: "Skill enabled",
      disabled: "Skill disabled",
      apiKeySaved: "API key saved — stored in openclaw.json (skills.entries.{skillKey})",
      installed: "Installed",
  ...
  dreaming: {
    ...
    diary: {
      ...
      preview: {
        defaultTitle: "Wiki page",
        loading: "Loading wiki page…",
        noContent: "No wiki content available.",
        notFound: "No wiki page found for {lookup}.",
        truncated: "Showing the first chunk of this page.",
        truncatedWithLines: "Showing the first chunk of this page ({totalLines} total lines).",
      },
      counts: {
        pageOne: "{count} page",
        pageOther: "{count} pages",
        claimRowOne: "{count} claim row",
        claimRowOther: "{count} claim rows",
        openQuestionOne: "{count} open question",
        openQuestionOther: "{count} open questions",
        contradictionOne: "{count} contradiction",
        contradictionOther: "{count} contradictions",
        chatOne: "{count} chat",
        chatOther: "{count} chats",
        sensitive: "{count} sensitive",
        signalOne: "{count} signal",
        signalOther: "{count} signals",
      ...
      imports: {
        ...
        withheldOne: "{count} digest was withheld pending review.",
        withheldOther: "{count} digests were withheld pending review.",
        risk: {
      ...
      palace: {
        ...
        questionPages: " on {pages}",
        vault: "Vault",
        fullBreakdown: "Full vault breakdown: {breakdown}.",
        selectedSection: "Selected section: {summary}.",
        latestUpdate: "Latest update {updatedAt}.",
      },
      memoryWiki: {
        disabledTitle: "Memory Wiki is not enabled",
        pluginHintPrefix: "Imported Insights and Memory Palace are provided by the bundled",
        pluginHintSuffix: "plugin.",
        configHintPrefix: "Enable",
        configHintSuffix: ", then reload this tab.",
      },
